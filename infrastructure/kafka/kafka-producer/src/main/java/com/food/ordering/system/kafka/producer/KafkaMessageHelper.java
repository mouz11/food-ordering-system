...
public class KafkaMessageHelper {
    ...
    public <T, U> BiConsumer<SendResult<String, T>, Throwable> getKafkaCallback(String topicName, T avroModel, U outboxMessage,
            ...
            public void accept(SendResult<String, T> result, Throwable throwable) {
                if (throwable != null) {
                    log.error("Error while sending {} with message {} and outbox type: {} to topic {}"
                            ,avroModelName, avroModel.toString(), outboxMessage.getClass().getName(), topicName, throwable);

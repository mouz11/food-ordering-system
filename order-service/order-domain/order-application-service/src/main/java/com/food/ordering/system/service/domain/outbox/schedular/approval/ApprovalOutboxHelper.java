package com.food.ordering.system.service.domain.outbox.schedular.approval;
...
public class ApprovalOutboxHelper {
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        try {
            ...
            log.error("Could not create OrderApprovalPayload for order id: {}", orderApprovalEventPayload.getOrderId(), e);
            throw new OrderDomainException("Could not create OrderApprovalPayload for order id: " +

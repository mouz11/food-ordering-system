...
//@Validated to enable validation we set in the interface
@Slf4j
@Validated
@Service
//package private because we gonna give him the interface is enough he dont have to see the implementation class

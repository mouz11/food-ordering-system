...
public class PaymentOutboxScheduler implements OutboxScheduler {
    ...
    public void processOutboxMessage() {
        Optional<List<OrderPaymentOutboxMessage>> outboxMessagesResult = paymentOutboxHelper.getPaymentOutboxMessageByOutboxStatusAndSagaStatus(OutboxStatus.STARTED,
                SagaStatus.STARTED, SagaStatus.COMPENSATING);

        if (outboxMessagesResult.isPresent()) {
            List<OrderPaymentOutboxMessage> outboxMessages = outboxMessagesResult.get();

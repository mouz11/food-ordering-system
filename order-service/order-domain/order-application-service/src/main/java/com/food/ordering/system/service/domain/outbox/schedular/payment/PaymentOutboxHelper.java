...
public class PaymentOutboxHelper {
    ...
    public void save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        ...
        if (response == null) {
            log.error("Could not save OrderPaymentOutboxMessage <ith outbox id: {}", orderPaymentOutboxMessage.getId());
            throw new OrderDomainException("Could not save OrderPaymentOutboxMessage with outbox id: " +
                    orderPaymentOutboxMessage.getId());
        }
        log.info("OrderPaymentOutboxMessage saved Successfully for outbox id: {}", response.getId());
    }
    @Transactional

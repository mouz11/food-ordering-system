...
import com.food.ordering.system.restaurant.service.domain.ports.input.listener.RestaurantApprovalRequestMessageListener;
...
public class RestaurantApprovalRequestMessageListenerImpl implements RestaurantApprovalRequestMessageListener {
    ...
    public void approveOrder(RestaurantApprovalRequest restaurantApprovalRequest) {
        ...
        fire(orderApprovalEvent);
    }

    private void fire(OrderApprovalEvent orderApprovalEvent) {
